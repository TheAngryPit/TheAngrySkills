...
This file defines the SCRIPT.md **shape** only. Synthesizing the spoken lines into audio is a capability owned by `media-use` → `../../hyperframes-media-use/audio/references/tts.md`.
