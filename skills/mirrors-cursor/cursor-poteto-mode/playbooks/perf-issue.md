...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation through native bounded delegation while respecting the selected model and effort. Review the diff. Capture a post-fix trace.
