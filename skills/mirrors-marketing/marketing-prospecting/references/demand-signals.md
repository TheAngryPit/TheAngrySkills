...
For a shareable standalone HTML version of this report, the JSON→HTML generator pattern in ad-creative's [creative-review-page.md](../../marketing-ad-creative/references/creative-review-page.md) is the model (escape every value; keep it self-contained).
