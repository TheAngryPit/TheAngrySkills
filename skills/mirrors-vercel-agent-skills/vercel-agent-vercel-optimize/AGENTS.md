...
cp -R <agent-skills-repo>/mirrors/mirrors-vercel-agent-skills/vercel-agent-vercel-optimize .agents/skills/
```
...
`.agents/mirrors/mirrors-vercel-agent-skills/vercel-agent-vercel-optimize/SKILL.md` before proposing changes.
