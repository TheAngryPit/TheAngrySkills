...
Keep changes small, metric-grounded, and fixture-tested. Runtime code lives in `skills/vercel-agent-vercel-optimize`; tests and fixtures live in `packages/vercel-optimize-tests` so installed skills stay small.
...
| Citation | `references/docs-library.json` | `node skills/vercel-agent-vercel-optimize/scripts/check-citations.mjs` |
...
```bash
node skills/vercel-agent-vercel-optimize/scripts/build-docs.mjs
node skills/vercel-agent-vercel-optimize/scripts/check-docs-fresh.mjs
```
...
node skills/vercel-agent-vercel-optimize/scripts/check-docs-fresh.mjs
node skills/vercel-agent-vercel-optimize/scripts/check-citations.mjs
```
