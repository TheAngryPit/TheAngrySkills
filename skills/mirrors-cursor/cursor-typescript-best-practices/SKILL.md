---
name: cursor-typescript-best-practices
...
Apply the **cursor-principle-type-system-discipline** skill first.
...
| Boundary validation | Parse where data crosses in, into a named domain type. `Record<string, unknown>` (however spelled) stops at that parse. Trust types inside. See the **cursor-principle-boundary-discipline** skill. |
