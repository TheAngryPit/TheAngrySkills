...
1. Read `mirrors/mirrors-marketing/marketing-ideas/references/ideas-by-category.md` in the `marketingskills` repo
...
- `mirrors/mirrors-marketing/marketing-ideas/SKILL.md` (in the `marketingskills` repo)
- `mirrors/mirrors-marketing/marketing-ideas/references/ideas-by-category.md` (in the `marketingskills` repo)
