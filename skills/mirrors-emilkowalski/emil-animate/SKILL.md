...
If the task needs a *component* rather than an animation — a toast, a drawer, a command menu, a dropdown — stop and invoke `emil-pick-ui-library`. Hand-rolling those is how you end up with a `<div>` dropdown and no focus management.
