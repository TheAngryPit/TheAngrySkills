...
Manual install: copy `mirrors/mirrors-vercel-agent-skills/vercel-agent-vercel-optimize` into `.agents/mirrors/mirrors-vercel-agent-skills/vercel-agent-vercel-optimize` and reference `SKILL.md` from your project `AGENTS.md`.
