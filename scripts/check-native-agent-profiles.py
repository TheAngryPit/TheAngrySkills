...
ASSET_ROOT = ROOT / "skills/core/model-capability-router/assets/agents"
SOURCE_ROOT = ROOT / "sources/cursor-plugins/snapshot/pstack/agents"
...
def validate_profile(
    ...
    return {
        "name": name,
        "asset": str(profile_path.relative_to(ROOT)),
