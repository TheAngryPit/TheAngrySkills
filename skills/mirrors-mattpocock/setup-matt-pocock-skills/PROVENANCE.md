# setup-matt-pocock-skills: approved adaptation
...
Record only choices that remain open, follow the active harness instruction file, and treat package-layout signals as evidence without assuming a single context.
