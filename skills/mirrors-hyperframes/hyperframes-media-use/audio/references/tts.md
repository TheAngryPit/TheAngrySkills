...
node skills/hyperframes-media-use/audio/scripts/heygen-tts.mjs ./script.txt -o narration.wav
node skills/hyperframes-media-use/audio/scripts/heygen-tts.mjs --list   # public starfish voices
```
