# scaffold-exercises: approved adaptation
...
Keep the exact exercise lint command, allow documented variants, require proof for solution-only exercises, and limit commits to task changes.
