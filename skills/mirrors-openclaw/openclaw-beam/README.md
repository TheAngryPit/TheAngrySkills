...
```sh
export BEAM_SKILL_DIR="${AGENTS_HOME:-$HOME/.agents}/skills/openclaw-beam"
...
```sh
node --check skills/openclaw-beam/scripts/beam
node --check skills/openclaw-beam/scripts/beam-session.js
node --test skills/openclaw-beam/scripts/beam.test.mjs
