...
Manual install: copy `skills/vercel-agent-vercel-optimize` into `.agents/skills/vercel-agent-vercel-optimize` and reference `SKILL.md` from your project `AGENTS.md`.
