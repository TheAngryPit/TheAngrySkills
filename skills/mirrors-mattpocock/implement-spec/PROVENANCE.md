# implement-spec: approved adaptation
...
Treat explicitly scoped invocations as mutation authorization and support branch-only or native-harness constraints without adding a second approval gate.
