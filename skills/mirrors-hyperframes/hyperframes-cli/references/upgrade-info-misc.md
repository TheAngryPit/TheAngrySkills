...
For voice selection, Whisper model rules, output format choice, and the TTS → transcript → captions chain, invoke the `hyperframes-media-use` skill. This skill stays focused on the dev loop.
