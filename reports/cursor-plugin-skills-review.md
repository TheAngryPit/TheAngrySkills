...
Scope: skills and their support files only; no plugin, global install or merge.
...
Eleven focused tests cover reproducibility, local-edit preservation, source-drift
...
The 62 runnable `unittest` cases pass; two other test modules require `pytest`,
