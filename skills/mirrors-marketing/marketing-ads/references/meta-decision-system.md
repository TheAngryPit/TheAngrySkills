...
Format-level guidance on *which* creator-fronted formats to run (founder content, yapper, authority, amateur-investigation, creator low-fi statics, etc.) lives in the ad-creative format taxonomy: [meta-creative-formats.md](../../marketing-ad-creative/references/meta-creative-formats.md) *(sibling addition — forward link)*.
