...
- You need a competitor's paid-creative mix (formats, partnership share, messaging) before briefing new ads — feeds the concept slate in [ad-creative](../../marketing-ad-creative/SKILL.md).
...
This is the *paid-social creative research* cut. For structured competitor dossiers from a URL list, hand off to [competitor-profiling](../../marketing-competitor-profiling/SKILL.md). For deep voice-of-customer analysis and JTBD, hand off to [customer-research](../../marketing-customer-research/SKILL.md). Persona output feeds [positioning](../../positioning/SKILL.md).
...
Run it against your competitors, your *clients'* competitors, or brands you admire for inspiration. Ask follow-up questions against the generated report in the same chat. For a full structured competitor dossier (pricing, positioning, SEO), hand the shortlist to [competitor-profiling](../../marketing-competitor-profiling/SKILL.md).
...
- **Ad-library + format/partnership findings →** the concept slate and hook briefs in [ad-creative](../../marketing-ad-creative/SKILL.md).
- **Personas doc →** shared context for [customer-research](../../marketing-customer-research/SKILL.md), [copywriting](../../marketing-copywriting/SKILL.md), and [positioning](../../positioning/SKILL.md).
- **Organic teardown shortlist →** a full dossier in [competitor-profiling](../../marketing-competitor-profiling/SKILL.md).
