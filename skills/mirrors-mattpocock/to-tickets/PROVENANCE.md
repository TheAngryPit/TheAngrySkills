# to-tickets: approved adaptation
...
Limit prefactoring to demonstrated blockers or blast-radius reduction, while retaining tracker paths required by the configured local workflow.
