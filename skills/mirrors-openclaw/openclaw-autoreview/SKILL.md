...
export AUTOREVIEW=".claude/skills/openclaw-autoreview/scripts/autoreview"
export AUTOREVIEW_HARNESS=".claude/skills/openclaw-autoreview/scripts/test-review-harness"
```
