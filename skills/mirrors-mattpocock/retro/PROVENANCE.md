# retro: approved adaptation

Source: [https://github.com/mattpocock/skills.git](https://github.com/mattpocock/skills.git).
Reviewed source revision: 959a8e9f1edc3adbe2f7e3054bb6fbefa6696260.
Operator approved the final Matt Pocock integration on 2026-09-12. MIT attribution is retained in LICENSE.

## What changed and why

Use the Astra writing route, scope coding-standards and instruction review to the active harness, and describe implementation and review responsibilities from actual evidence. Port the upstream deterministic-check guidance: inspect the repository's own check path before proposing a guardrail, treat absent guardrails as a finding, and route mechanical coding-standard violations to deterministic checks while reserving judgement calls for prose guidance.
