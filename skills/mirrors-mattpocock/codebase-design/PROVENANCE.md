# codebase-design: approved adaptation
...
Preserve established domain terms, require evidence for seams, and replace shallow tests only after interface behavior is covered.
